...
import com.example.luzcamacho.parstagram.model.PosterBoi;
...
public class CameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* got to invoke an intent to launch the canera */
        View picture = findViewById(R.id.BigView);
        submit = findViewById(R.id.btSubmit);
        etCaption = findViewById(R.id.etSetCaption);
        onLaunchCamera(picture);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PosterBoi hero = new PosterBoi();
                hero.publishPost(description, file, user);
            }
        });
    ...
    public void onLaunchCamera(View view) {
        ...
        Uri fileProvider = FileProvider.getUriForFile(CameraActivity.this, "com.example.luzcamacho.parstagram", photoFile);
